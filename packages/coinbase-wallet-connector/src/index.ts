...
interface CoinbaseWalletSDKConnectorArguments {
  url: string
  appName: string
  appLogoUrl?: string
  darkMode?: boolean
...
export class CoinbaseWalletSDKConnector extends AbstractConnector {
  ...
  constructor({ url, appName, appLogoUrl, darkMode, supportedChainIds }: CoinbaseWalletSDKConnectorArguments) {

...
| _QR Code_                             |
| `@web3-react/coinbase-wallet-connector`    | [![npm version](https://img.shields.io/npm/v/@web3-react/coinbase-wallet-connector/latest.svg)](https://www.npmjs.com/package/@web3-react/coinbase-wallet-connector/v/latest)       | [![minzip](https://img.shields.io/bundlephobia/minzip/@web3-react/coinbase-wallet-connector/latest.svg)](https://bundlephobia.com/result?p=@web3-react/coinbase-wallet-connector@latest)       | [Coinbase Wallet](https://www.coinbase.com/wallet/developers) Connector                               |
